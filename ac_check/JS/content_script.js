if(typeof init === 'undefined'){
	...
	const init = function(){
		...
		if(main === null && loc !== 'www.w3.org' && !loc.startsWith("chrome://")){
			...
			codigo_nav+= '<br><br><p class="titulo_sb">&nbsp;<u>Report content</u>:</p><p id="tabla_res"></label><br><br><p id="tabla_contenido"></p><br><br><br>';
			codigo_nav+= '<script type="text/javascript" src="http://127.0.0.1:5000/tablas.js">';
